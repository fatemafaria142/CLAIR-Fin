"""CLI entry point that monkeypatches the pipeline's retrieval with HyDE and generates chapter responses."""
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Generate HyDE-RAG responses for a chapter")
